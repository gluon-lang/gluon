...
*   Add holes to the type syntax, and use them when building the AST ([fb9bd82c](https://github.com/Marwes/gluon/commit/fb9bd82ce7792332e8a660e3f0ea05843d50f6d5))
*   Rename (*) to Type ([8a3e1945](https://github.com/Marwes/gluon/commit/8a3e194581d3c9eef70e94660c3edb89f3706629))
*   Repl UX improvements ([2ed0a35b](https://github.com/Marwes/gluon/commit/2ed0a35bd0e194ae9bd37b189c3f4bb59f6c6845))
...
* **vm:**
  ...
  *  read GLUON_PATH from env var and add to new_vm (#79) ([e7254a40](https://github.com/Marwes/gluon/commit/(e7254a40f24d53fac6074b1189eda66032f7efc7)))
...
*   Don't return None from Source::location when byte is at end of file ([5aee09a5](https://github.com/Marwes/gluon/commit/5aee09a5518fbff972683644cd99ab07a5674016))
* **check:**
...
*   use fnv instead of SipHasher for HashMaps. add type FnvMap (#106) ([4a64c68d](https://github.com/Marwes/gluon/commit/4a64c68d8d04a6788f1fea3d6f25471b873ee8e2))

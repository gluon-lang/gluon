//! Code formatter.
#![doc(html_root_url = "https://docs.rs/gluon_formatter/0.11.2")] // # GLUON
...
pub fn pretty_expr(input: &Source, expr: &SpannedExpr<Symbol>) -> String {
...
impl Formatter {
    pub fn pretty_expr(&self, source: &Source, expr: &SpannedExpr<Symbol>) -> String {
